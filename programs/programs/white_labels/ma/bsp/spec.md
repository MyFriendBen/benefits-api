...
- **User-facing handling**: The program description states that adopted children can qualify at any age within one year of the adoption, explains that the screener does not ask about adoption and so only shows BabySteps for children under one, and directs families who adopted within the past year to check with MEFA directly.
