...
|---|-----------|-----------------|---------------|-------|--------|
| 1 | Worked in jobs covered by Social Security | — | ❌ | `worked_in_last_18_mos` field exists but is not collected by the screener; cannot verify SS-covered employment history | 20 CFR § 404.101, 404.110–404.146 |
...
| 6 | Sufficient work credits (generally 40 credits, 20 in last 10 years for age 31+) | — | ❌ | Requires SSA earnings records; screener does not collect work history | 20 CFR § 404.130, 404.140–404.146 |
...
| 10 | Insured status — worked in 5 of last 10 years (age 31+) | — | ❌ | Requires quarters of coverage in specific periods; screener does not collect work history | 20 CFR § 404.130, 404.140 |
...
### Scenario 1: Disabled Worker Under FRA with No SGA Income

**Checks**: Core happy path — disabled, under FRA, not earning SGA
**Expected**: Eligible
...
**Why this matters**: Most straightforward SSDI profile — working-age adult with a long-term disability, below SGA, and under FRA. Tests the core evaluable criteria: long-term disability, SGA (no income), age under FRA, and citizenship.
...
**Why this matters**: Validates that multiple household members can independently qualify and are each evaluated on their own disability status and income.
