...
from programs.programs.co.rental_assistance_grant.calculator import RAGCache
...
class TestRAGCacheProcess(SimpleTestCase):
    ...
    @patch("programs.programs.co.rental_assistance_grant.calculator.capture_message")
