"""
Unit tests for the KS member-level PolicyEngine calculator (KsKanCare / KS Medicaid, MFB-1054).
...
2. **Scenario coverage** — one test per validation scenario in
   ``validations/.../ks_medicaid.json`` (and the ``## Test Scenarios`` section of
   ...
   PolicyEngine and is verified end-to-end by ``python manage.py validate --program ks_medicaid``.
...
from programs.programs.ks.pe.member import KsKanCare
