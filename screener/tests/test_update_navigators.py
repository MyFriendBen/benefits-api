...
class TestNavigatorCountyFilter(TestCase):
    ...
    def test_no_counties_matches_any_screen_county(self) -> None:
    ...
    def test_no_counties_matches_none_screen_county(self) -> None:
    ...
    def test_matching_county_includes_navigator(self) -> None:
    ...
    def test_non_matching_county_excludes_navigator(self) -> None:
    ...
    def test_none_screen_county_excludes_county_restricted_navigator(self) -> None:
        """Navigator with county restrictions is excluded when screen county is None."""
        result = filter_by_county([self.durham_nav], None)
        self.assertNotIn(self.durham_nav, result)

    def test_mixed_navigators_filtered_independently(self) -> None:
...
class TestNavigatorEligibilityProgramsFilter(TestCase):
    ...
    def test_no_required_programs_always_shown(self) -> None:
    ...
    def test_required_program_eligible_shows_navigator(self) -> None:
    ...
    def test_required_program_ineligible_hides_navigator(self) -> None:
    ...
    def test_required_program_missing_hides_navigator(self) -> None:
    ...
    def test_all_required_programs_must_be_eligible(self) -> None:
    ...
    def test_all_required_programs_eligible_shows_navigator(self) -> None:
...
class TestNavigatorReferrerPrioritization(TestCase):
    ...
    def test_no_primary_navigators_returns_full_eligibility_list(self) -> None:
    ...
    def test_overlapping_primary_navigators_returns_only_overlap(self) -> None:
    ...
    def test_no_overlap_falls_back_to_full_eligibility_list(self) -> None:
    ...
    def test_primary_navigators_subset_returns_matching_subset(self) -> None:
    ...
    def test_primary_navigators_order_preserved_from_primary_list(self) -> None:
...
class TestUpdateNavigators(TestCase):
    ...
    def test_statewide_nav_shown_for_any_county(self) -> None:
    ...
    def test_county_nav_shown_for_matching_county(self) -> None:
        """Navigator restricted to Dallas appears when screen county is Dallas."""
        ids = self._run(screen_county="Dallas")
        self.assertIn(self.dallas_nav.id, ids)

    def test_county_nav_hidden_for_non_matching_county(self) -> None:
    ...
    def test_referrer_primary_nav_takes_priority(self) -> None:
    ...
    def test_referrer_falls_back_when_no_primary_nav_passes(self) -> None:
    ...
    def test_data_navigators_field_is_populated(self) -> None:
