...
def make_calculator(has_ssdi=False):
    ...
    return KsSsdi(mock_screen, mock_program, {}, mock_missing_deps)
...
class TestKsSsdiClassAttributes(TestCase):
    ...
    def test_member_amount(self):
        self.assertEqual(KsSsdi.member_amount, 1_634 * 12)


class TestKsSsdiFraSchedule(TestCase):
    def test_born_1954_fra_is_66_0(self):
        self.assertEqual(KsSsdi._get_fra(1954), (66, 0))

    def test_born_1955_fra_is_66_2(self):
        self.assertEqual(KsSsdi._get_fra(1955), (66, 2))

    def test_born_1957_fra_is_66_6(self):
        self.assertEqual(KsSsdi._get_fra(1957), (66, 6))

    def test_born_1960_fra_is_67_0(self):
        self.assertEqual(KsSsdi._get_fra(1960), (67, 0))

    def test_born_1943_fra_is_66_0(self):
        self.assertEqual(KsSsdi._get_fra(1943), (66, 0))
