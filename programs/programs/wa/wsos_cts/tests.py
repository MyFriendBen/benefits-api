...
class TestWaWsosCts(TestCase):
    ...
    def test_no_published_lump_sum_value(self) -> None:
    ...
    def test_scenario_1_eligible_student_below_mfi(self) -> None:
    ...
    def test_scenario_2_ineligible_not_a_student(self) -> None:
    ...
    def test_scenario_3_ineligible_income_above_mfi(self) -> None:
        """Scenario 3: student, $8,000/mo — above 125% MFI (no expanded path)."""
        screen = self._make_screen()
        self._add_member(screen, age=24, student=True, monthly_wages=8000)
        self.assertFalse(self._calc(screen).eligible().eligible)

    def test_scenario_4_three_person_at_exact_mfi_boundary(self) -> None:
    ...
    def test_scenario_4_three_person_one_cent_above_annual_mfi_ineligible(self) -> None:
    ...
    def test_scenario_5_rji_candidate_still_cts_eligible(self) -> None:
    ...
    def test_scenario_6_four_person_above_mfi(self) -> None:
    ...
    def test_eligible_when_only_dependent_is_student(self) -> None:
    ...
    def test_income_slightly_above_limit_rejected(self) -> None:
    ...
    def test_mfi_linear_extension_size_7(self) -> None:
    ...
    def test_value_zero_when_eligible(self) -> None:
        screen = self._make_screen()
    ...
    def test_mfi_table_matches_spec(self) -> None:
        self.assertEqual(
