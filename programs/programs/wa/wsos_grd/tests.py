...
class TestWaWsosGrd(TestCase):
    ...
    def test_eligible_single_student_below_125_pct_mfi(self) -> None:
    ...
    def test_ineligible_not_a_student(self) -> None:
    ...
    def test_ineligible_single_student_above_155_pct_mfi(self) -> None:
    ...
    def test_eligible_three_person_household_at_125_pct_mfi_boundary(self) -> None:
        """
    ...
    def test_eligible_single_student_in_expanded_126_to_155_band(self) -> None:
        """
    ...
    def test_eligible_three_person_household_in_expanded_band(self) -> None:
        """
    ...
    def test_ineligible_three_person_household_above_155_pct_mfi(self) -> None:
    ...
    def test_value_is_25000_lump_sum(self) -> None:
