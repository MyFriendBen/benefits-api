...
class TestSsiDependency(TestCase):
    ...
    Verification for MFB-1382 scope item 3: MFB-1312's actual-receipt contract requires the
    reported dollar amount to reach PolicyEngine as the person-level `ssi` input. The value
    is annual; pe_input() writes it under the program's period (`{"ssi": {"<year>": amount}}`)
    and PolicyEngine spreads an annual figure across the months itself.
    """
