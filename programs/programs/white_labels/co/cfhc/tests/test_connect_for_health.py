...
from programs.programs.white_labels.co.cfhc.calculator import CfhCountyValuesCache, ConnectForHealth
...
class TestConnectForHealthValue(TestCase):
    ...
    @patch("programs.programs.white_labels.co.cfhc.calculator.capture_message")
