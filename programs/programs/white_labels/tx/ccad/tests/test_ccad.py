...
from programs.programs.white_labels.tx.ccad.calculator import TxCcad
...
def make_calculator(
    ...
    # SNAP/TANF are read via base_program; has_benefit is stubbed False so an exact-name
    # read can't pass on a Mock's truthy default.
