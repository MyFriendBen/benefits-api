...
class WaOrcaLift(ProgramCalculator):
    ...
    Value: $864/year per eligible cardholder (= $72/month PugetPass differential × 12).
    """

    min_age = 19
    max_age = 64
    fpl_percent = 2.0
    member_amount = 864  # $72/month × 12 months (monthly PugetPass fare differential)
    ...
    def household_eligible(self, e: Eligibility):
        categorical = (
            self.screen.has_benefit("medicaid") or self.screen.has_benefit("snap") or self.screen.has_benefit("wic")
        )
