...
class TestIlMsp(TestCase):
    ...
    def test_is_registered_in_il_member_calculators(self) -> None:
    ...
    def test_pe_name_is_msp(self) -> None:
    ...
    def test_pe_inputs_includes_medicare_eligibility(self) -> None:
    ...
    def test_pe_inputs_includes_asset_dependency(self) -> None:
...
class TestIlAabd(TestCase):
    ...
    def test_pe_name_is_il_aabd_person(self) -> None:
    ...
    def test_pe_inputs_includes_disability_dependencies(self) -> None:
    ...
    def test_pe_inputs_includes_income_dependencies(self) -> None:
...
class TestIlHbwd(TestCase):
    ...
    def test_pe_name_is_il_hbwd_person(self) -> None:
    ...
    def test_pe_inputs_includes_earned_income_dependencies(self) -> None:
    ...
    def test_pe_outputs_includes_il_hbwd_eligible(self) -> None:
        """Test that IlHbwdEligible is in pe_outputs."""
        self.assertIn(member_dependency.IlHbwdEligible, IlHbwd.pe_outputs)

    def test_pe_outputs_includes_il_hbwd_premium(self) -> None:
...
class TestIlBccp(TestCase):
    ...
    def test_pe_inputs_includes_female_dependency(self) -> None:
        """Test that IlBccFemaleDependency is in pe_inputs."""
        self.assertIn(member_dependency.IlBccFemaleDependency, IlBccp.pe_inputs)

    def test_pe_inputs_includes_insurance_eligibility_dependency(self) -> None:
    ...
    def test_pe_inputs_includes_receives_medicaid_dependency(self) -> None:
    ...
    def test_pe_outputs_includes_il_bcc_eligible(self) -> None:
        """Test that IlBccEligible is in pe_outputs."""
        self.assertIn(member_dependency.IlBccEligible, IlBccp.pe_outputs)

    def test_member_value_returns_400_when_eligible(self) -> None:
        """
...
class TestIlMpe(TestCase):
    ...
    def test_pe_name_is_il_mpe_eligible(self) -> None:
    ...
    def test_pe_inputs_includes_expected_children_dependency(self) -> None:
    ...
    def test_pe_outputs_includes_il_mpe_eligible(self) -> None:
        """Test that IlMpeEligible is in pe_outputs."""
        self.assertIn(member_dependency.IlMpeEligible, IlMpe.pe_outputs)

    def test_member_value_returns_zero_when_has_medicaid(self) -> None:
...
class TestIlFamilyPlanningProgram(TestCase):
    ...
    def test_is_registered_in_il_pe_calculators_for_hfs_fpp(self) -> None:
    ...
    def test_is_registered_in_il_pe_calculators_for_fppe(self) -> None:
    ...
    def test_pe_name_is_il_fpp_eligible(self) -> None:
    ...
    def test_pe_inputs_includes_tax_unit_head_dependency(self) -> None:
    ...
    def test_pe_inputs_includes_tax_unit_spouse_dependency(self) -> None:
    ...
    def test_pe_outputs_includes_il_fpp_eligible(self) -> None:
...
class TestIlFppEligible(TestCase):
    ...
    def test_field_is_il_fpp_eligible(self) -> None:
