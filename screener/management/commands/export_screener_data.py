...
class Command(BaseCommand):
    ...
    def _build_data_dictionary(self):
        ...
        descriptions = {
            ...
            "income_stream.type": "Income type grouping (employment, government, support, investment)",
            "income_stream.source": "Specific income source (wages, selfEmployment, sSI, etc.)",
