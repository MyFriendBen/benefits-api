...
```json
{
  ...
  "program": {
    ...
    "name": "Head Start",
    "description": "Head Start is a free program for young children ages 3 to 5. It offers preschool classes, meals, and health checkups. Your child also gets help learning and growing. Families pay nothing to join.\n\nFamilies with low income can apply. Children who get SNAP (food stamps), TANF (cash help), or SSI (disability benefits) qualify right away. Children in foster care also qualify. Children without a stable home qualify too.",
