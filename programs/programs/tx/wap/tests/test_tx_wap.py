...
class TestTxWapClassAttributes(TestCase):
    ...
    def test_fpl_percent_is_2(self) -> None:
        self.assertEqual(TxWap.fpl_percent, 2)

    def test_amount_is_372(self) -> None:
...
class TestTxWapIncomeEligibility(TestCase):
    ...
    def test_income_below_200_fpl_is_eligible(self) -> None:
    ...
    def test_income_exactly_at_200_fpl_is_eligible(self) -> None:
    ...
    def test_income_above_200_fpl_is_ineligible(self) -> None:
    ...
    def test_four_person_household_at_200_fpl_is_eligible(self) -> None:
    ...
    def test_three_person_household_just_above_200_fpl_is_ineligible(self) -> None:
...
class TestTxWapCategoricalEligibility(TestCase):
    ...
    def test_priority_traits_do_not_override_income_ceiling(self) -> None:
