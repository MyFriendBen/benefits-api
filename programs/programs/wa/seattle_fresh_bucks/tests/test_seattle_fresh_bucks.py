...
class TestWaSeattleFreshBucks(TestCase):
    ...
    def test_amount_is_yearly(self) -> None:
        self.assertEqual(WaSeattleFreshBucks.amount, 60 * 12)

    def test_min_age_is_18(self) -> None:
        self.assertEqual(WaSeattleFreshBucks.min_age, 18)

    def test_max_ami_percent_is_80(self) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_all_test_scenario_zips_are_seattle(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_eligible_head_age_18(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        self.head.age = 18
        self.head.save()
        calc = self.create_calculator()
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_ineligible_head_age_17(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        self.head.age = 17
        self.head.save()
        calc = self.create_calculator()
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_eligible_senior_head(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        self.head.age = 72
        self.head.save()
        calc = self.create_calculator()
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_ineligible_head_age_none(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        self.head.age = None
        self.head.save()
        calc = self.create_calculator()
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_eligible_income_below_ami(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 84_850  # 80% AMI 1-person
        calc = self.create_calculator()
        self.assertTrue(calc.eligible().eligible)

    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_eligible_income_exactly_at_ami(self, mock_hud) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_ineligible_income_above_ami(self, mock_hud) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_eligible_zero_income(self, mock_hud) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_ineligible_on_hud_client_error(self, mock_hud) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_hud_client_called_with_correct_args(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        calc = self.create_calculator()
        calc.eligible()
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_value_is_yearly_when_eligible(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
        calc = self.create_calculator()
        e = calc.eligible()
        calc.value(e)
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_value_is_household_level_not_per_member(self, mock_hud) -> None:
    ...
    @patch("programs.programs.wa.seattle_fresh_bucks.calculator.hud_client")
    def test_value_is_0_when_ineligible(self, mock_hud) -> None:
        mock_hud.get_screen_il_ami.return_value = 100_000
